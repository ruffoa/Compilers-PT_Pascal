{  PT Semantic Analysis Pass   Ver. 4.2
...
{ ===== Pasted contents of semantic.def, generated by S/SL from semantic.ssl -
        ...
        oTypeStkLinkToStandardComponentType = 43; { (16) }
        oTypeStkEnterBounds = 44;
        oTypeStkVerifyBounds = 45; { >>14 }
        oTypeStkEnterParameterCount = 46;
        oTypeStkCompareParameterCount = 47; { >>14 }
        oTypeStkEnterComponentReference = 48;
        oTypeStkChooseKind = 49; { >>20 }
        oTypeStkChooseTypeReference = 50; { >>14 }
        oTypeStkCompareNames = 51; { >>14 }
        oTypeStkSwap = 52;
        oTypeStkPop = 53;
        oEmitNullAddress = 54;
        oEmitValue = 55;
        ...
        oEmitDataAddress = 57;
        oEmitTrapKind = 58; { (21) }
        oEmitCaseBranchTable = 59;
        oAllocateAlignOnWord = 60;
        oAllocateVariable = 61;
        oAllocateVarParameter = 62;
        oAllocateDescriptor = 63;
        oValuePush = 64; { (13) }
        oValuePushInteger = 65;
        ...
        oCountDecrement = 82;
        oCountChoose = 83; { >>13 }
        oFixPushForwardBranch = 84;
        oFixPopForwardBranch = 85;
        oFixPushTargetAddress = 86;
        oFixPopTargetAddress = 87;
        oFixPopAndEnterValue = 88;
        oFixSwap = 89;
        ...
        tAssignBoolean = 31;
        tAssignString = 32;
        tStoreParmAddress = 33;
        tStoreParmInteger = 34;
        tStoreParmChar = 35;
        tStoreParmBoolean = 36;
        tStoreParmString = 37;
        tSubscriptBegin = 38;
        tSubscriptAddress = 39;
        tSubscriptInteger = 40;
        tSubscriptChar = 41;
        tSubscriptBoolean = 42;
        tSubscriptString = 43;
        tArrayDescriptor = 44;
        tFileDescriptor = 45;
        tIfBegin = 46;
        ...
        Block = 101;
        AllocateVar = 768;
        ProcedureDefinition = 846;
        ConstantDefinitions = 137;
        TypeDefinitions = 305;
        VariableDeclarations = 691;
        BeginStmt = 1190;
        ConstantValue = 151;
        SymbolStkPushDefaultIntegerConstant = 3934;
        SymbolStkPushDefaultCharConstant = 3946;
        TypeBody = 343;
        IndexType = 409;
        ComponentType = 428;
        SimpleType = 481;
        ValuePushValuePlusOne = 3925;
        TypeTblEnterIfNew = 399;
        SymbolStkPushDefaultIntegerType = 3958;
        SubrangeUpperBound = 629;
        ValuePushTypeBounds = 611;
        EnterVariableAttributes = 722;
        ProcedureHeading = 899;
        ProcedureParameterType = 945;
        ProcedurePrologue = 1003;
        CountPushCopy = 3930;
        Statement = 1071;
        AssignmentStmt = 1125;
        CallStmt = 1204;
        ...
        Variable = 2233;
        Expression = 1665;
        CompareAndSwapTypes = 2007;
        OpenProcedure = 2633;
        AssignProcedure = 2664;
        WriteProcedure = 2781;
        WritelnProcedure = 3319;
        ReadProcedure = 3377;
        ReadlnProcedure = 3739;
        ActualParameters = 1337;
        FlushActuals = 3998;
        VarActual = 1405;
        BooleanControlExpression = 3910;
        CaseSelectorExpression = 3893;
        CaseAlternative = 1561;
        Operand = 1693;
        UnaryOperator = 1830;
        BinaryOperator = 1862;
        FlushExpn = 3977;
        ConstantOperand = 2344;
        VariableOperand = 2383;
        FunctionOperand = 2410;
        SymbolStkPushDefaultIntegerVariable = 3965;
        FileOperand = 2608;
        CompareOperandAndResultTypes = 2107;
        CompareEqualityOperandTypes = 2168;
        CompareRelationalOperandTypes = 2118;
        VariableExtension = 2275;
        StandardFunctionActual = 2513;
        FileVariable = 3797;
        WriteText = 3111;
        WriteBinary = 3235;
        WriteStandardExpnList = 3044;
        TextFileVariable = 3838;
        ReadTextParameterList = 3507;
        ReadBinaryParameterList = 3573;
        ReadText = 3639;
        ReadBinary = 3668;
        }
            ...
            if not assertion then
                begin
                    ...
                    case number of
                        ...
                        assert9:
                            write ('component type is stdText in oTypeStkLinkToStandardComponentType');
                        assert10:
                ...
                case operation of
                    ...
                    oSymbolTblPopScope:
                        ...
                        begin
                            ...
                            { Pop symbol table frame for scope }
                            ...
                            { No local type definitions need be saved since parameters must be 
                              declared with global type names. }
                    ...
                    oSymbolStkLinkToStandardType:
                        { Set the top entry's type table link to point to the parameter-specified 
                          standard type table entry. }

                        case parameterValue of
                            stdInteger:
                                symbolStkTypeTblLink[symbolStkTop] := standardIntegerTypeRef;
                            stdChar:
                                symbolStkTypeTblLink[symbolStkTop] := standardCharTypeRef;
                            stdBoolean:
                                symbolStkTypeTblLink[symbolStkTop] := standardBooleanTypeRef;
                            stdText:
                                symbolStkTypeTblLink[symbolStkTop] := standardTextTypeRef;
                        end;
                    ...
                    oSymbolStkEnterCodeAddress:
                        { Set the top entry's value field to the offset of the next instruction 
                          to be emitted to the code area. }
                    ...
                    oTypeStkLinkToStandardComponentType:
                        ...
                        begin
                            ...
                            case parameterValue of
                                stdInteger:
                                    typeStkComponentLink[typeStkTop] := standardIntegerTypeRef;
                                stdChar:
                                    typeStkComponentLink[typeStkTop] := standardCharTypeRef;
                                stdBoolean:
                                    typeStkComponentLink[typeStkTop] := standardBooleanTypeRef;
                            end
                        end;
