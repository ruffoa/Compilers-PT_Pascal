...
-------------------------
```
### Semantic pass S/SL program failure:  syntax error in semantic token stream !== .tLiteralInteger on line 14 of bust.pt
### Semantic assertion 3 failed: !== oEmitValue on line 15 of bust.pt
 !== % value emitted 1 on line 16 of bust.pt
...
-------------------------
```
### Semantic pass S/SL program failure:  syntax error in semantic token stream !== .tLiteralInteger on line 14 of mbust.pt
### Semantic assertion 3 failed: !== oEmitValue on line 15 of mbust.pt
 !== % value emitted 1 on line 16 of mbust.pt
