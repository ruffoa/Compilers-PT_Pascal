{  PT Code Generator for Linux x86   Ver. 4.2
...
{ ===== Pasted contents of coder.def, generated by S/SL from coder.ssl -
        ...
        tStoreParmBoolean = 33;
        tStoreParmString = 34;
        tSubscriptBegin = 35;
        tSubscriptAddress = 36;
        tSubscriptInteger = 37;
        tSubscriptBoolean = 38;
        tSubscriptString = 39;
        tArrayDescriptor = 40;
        tFileDescriptor = 41;
        tIfBegin = 42;
        ...
        OperandCheckedSubscriptNonManifestStringPop = 1675;
        OperandUncheckedSubscriptNonManifestStringPop = 1747;
        OperandAssignStringPopPop = 3215;
            ...
            if not assertion then
                begin
                    ...
                    case number of
                        ...
                        assert19:
                            write ('compound token tCode is not tLiteralString in oOperandPushString');
                        assert20:
                        ...
                        assert24:
                            write ('compound token tCode is not tLiteralString in oOperandPushStringLength');
                        assert25:
                            write ('coder phase ended without consuming all of tCode token stream');
                        assert26:
                            write ('compound token tCode is not tLiteralString in oEmitString');
                        assert27:
                            write ('compound token tCode is not tCallEnd in oOperandPushProcedure');
                        assert28:
                            write ('compound token tCode is not tLiteralString in oOperandPushStringDescriptor');
                        assert29:
                        ...
                        assert32:
                            write ('compound token tCode is not tLiteralString in oOperandEnterValueFromStringLength');
                        assert33:
                ...
                case operation of
                    ...
                    oEmitStringLength:
                        begin
                            ...
                            EmitX86Code (iWord, false);
                            EmitX86DstMode (mWord, compoundTokenLength, undefined, undefined);
                        end;
                    ...
                    oOperandEnterValueFromStringLength:
                        begin
                            ...
                            operandStkValue[operandStkTop] := compoundTokenLength;
                        end;
